"""Auth API endpoints: thin wrappers over Client.

Each function takes a Client (which carries the bearer header if any)
...
def register(client: Client, *, email: str, password: str) -> dict[str, Any]:
...
def refresh(client: Client, *, refresh_token: str) -> dict[str, Any]:
